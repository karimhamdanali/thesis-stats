...
object LatexGenerator {
  ...
  def main(args: Array[String]) = {
    ...
    def emitCGSizeTable = {
      ...
      table.println("  \\caption{Comparing the size of the call graph generated by the \\ave-based tools to \\spark and \\doop in terms of call graph edges}")
      table.println("  \\label{table:cgsize}")
      table.println("  \\begin{tabularx}{\\textwidth}{lRRRR}")
      table.println("    \\toprule")
      table.println("    & \\multicolumn{2}{c}{\\spark} & \\multicolumn{2}{c}{\\doop} \\\\")
      table.println("    \\cmidrule(l){2-3} \\cmidrule(l){4-5}")
      table.println("    & \\whole & \\ave  & \\whole  & \\ave  \\\\")
      table.println("    \\cmidrule(l){2-3} \\cmidrule(l){4-5}")
